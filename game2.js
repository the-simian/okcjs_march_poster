...
function create() {
  ...
  var headText = game.add.text(game.world.centerX, 32 * miniScale, headerText, headerTextStyle);
  var headDate = game.add.text(game.world.centerX, 90 * miniScale, headerDate, headerDateStyle);
...
game = new Phaser.Game(500, 560, Phaser.AUTO, 'poster_game');
